              ...
              <div class="mt-2 divide-y divide-gray-200">
                ...
                <div class="mt-6">
                  <dl class="divide-y divide-gray-200">
                    ...
                    <div class="py-2 sm:py-2 sm:gap-4">
                      <div>
                        <label for="price" class="block text-xs font-small text-gray-700">People in group:</label>
                        <input v-model="data.value" type="text" name="price" id="price" class="bg-gray-200 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"/>
                      </div>
                    </div>

                    <div class="py-2 sm:py-2 sm:gap-4">
                      <div>
                        <label for="weekendinflation" class="block text-xs font-small text-gray-700">Discount:</label>
                        <div class="mt-1">
                          <input v-model="data.discount" type="text" name="weekendinflation" id="weekendinflation" class="bg-gray-200 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"  />
                        </div>
                      </div>
                    </div>
