            ...
            <div class="relative py-16 bg-white overflow-hidden">
              ...
              <div class="relative px-4 sm:px-6 lg:px-8">
                <div class="text-lg max-w-prose mx-auto">
                  <h1>
                    <span class="block text-base text-center text-indigo-600 font-semibold tracking-wide uppercase">Recouvrez la sérénité totale dans le domaine de</span>
                    <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Paradiso Park</span>
                  </h1>
                ...
                <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
                  ...
                  <ul role="list">
                    <li class="mt-2">- Quis elit egestas venenatis mattis dignissim.</li>
                    <li class="my-2">- Cras cras lobortis vitae vivamus ultricies facilisis tempus.</li>
                    <li class="mb-2">- Orci in sit morbi dignissim metus diam arcu pretium.</li>
                  </ul>
                  ...
                  <h2  class="mt-4 text-md font-bold text-gray-800">From beginner to expert in 30 days.</h2>
                  ...
                  <figure>
                    <img class="mt-4 w-full rounded-lg" src="img/63.webp" alt="garden_flowers" width="1310" height="873" />
                    <figcaption class="italic">"Sagittis scelerisque nulla cursus in enim consectetur quam."</figcaption>
                  </figure>
                  <h2 class="mt-4 text-md font-bold text-gray-800">Everything you need to get up and running</h2>
