...
.my-gallery{
  ...
  -webkit-column-count:4 !important; /* split it into 5 columns */
  -webkit-column-gap:5px !important; /* give it a 5px gap between columns */
...
.gallery-thumbnail{
  ...
  margin-bottom:5px !important;  /* to match column gap */
}
